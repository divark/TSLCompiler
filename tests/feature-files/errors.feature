Feature: An error message should be provided when an issue comes up with the Lexer or Parser.
    Scenario: The Parser reports an invalid Category.
        ...
        Then line 1 of the error message should mention finding PROPERTY_ELEMENT unexpectedly.
        ...
        Then line 5 of the error message should display a help message with 1 bullet points.
    ...
    Scenario: The Parser reports an error for the common case of a property followed by an if statement.
        ...
        When the error messages are redirected to be read by us,
        When the Parser consumes the input,
        Then line 1 of the error message should mention finding CONSTRAINT_START unexpectedly.
        ...
        Then line 6 of the error message should display a help message with 3 bullet points.
    ...
    Scenario: The Parser reports an error for the common case of a [single][error].
        ...
        When the error messages are redirected to be read by us,
        When the Parser consumes the input,
        Then line 1 of the error message should mention finding MARKING_ERROR unexpectedly.
